...
import com.karthyks.dice.searchdetails.SearchDetailsIntegrationTest_GeneratedInjector;
...
public final class Default_HiltComponents {
  ...
  @Component(
      modules = {
          ...
          HiltWrapper_TestCoroutinesModule.class,
          MusicBrainzServiceDIModule.class,
          NetworkDIModule.class,
          SearchDetailsTestDIModule.class,
          TestModule.class
      }
  )
  @Singleton
  public abstract static class SingletonC implements SearchDetailsIntegrationTest_GeneratedInjector,
